...
export interface PushViewValues {
  /**
   * View
   *
...
export const pushView = {
  key: "pushView",
  perform: async <TReturn>(values: PushViewValues): Promise<TReturn> => {
    const context = requireContext();
    return (await context.components.slack.pushView({ ...values })) as TReturn;
  },
  inputs: {
    view: {
      inputType: "code",
